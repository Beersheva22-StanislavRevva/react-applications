...
const SalaryStatistics: React.FC = () => {
    const {minSalary, maxSalary} = employeeConfig;
    const rangeValues:number[] = [5000, 1000, 2000, 3000, 10000];
    const field = "salary";
    ...
    const columns: GridColDef[] = [
        ...
        const rowsData = useMemo(()=> getStatistics(employees, "salary", range),[employees,range]);
