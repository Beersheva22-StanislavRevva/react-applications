...
import { Delete, Edit, Man, Woman, Pageview } from "@mui/icons-material";
import { useSelectorAuth } from "../../redux/store";
import { Confirmation } from "../common/Confirmation";
import { EmployeeForm } from "../forms/EmployeeForm";
import InputResult from "../../model/InputResult";
import { useDispatchCode, useSelectorEmployees } from "../../hooks/hooks";
import { EmployeePortraitView } from "../forms/EmployeePortraitView";
...
const Employees: React.FC = () => {
    ...
    const columnsAction: GridColDef[] = [
        {
            field: 'actions', type: "actions", getActions: (params) => {
                return [
                    <GridActionsCellItem label="details" icon={<Pageview />}
                        onClick={() => {
    ...
    return <Box sx={{
        ...
        >
            <Box sx={style}>
                <EmployeePortraitView submitFn={updateEmployee} employeeUpdated={employee.current} />
            </Box>
        </Modal>
