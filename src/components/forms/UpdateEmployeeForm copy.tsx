...
export const UpdateEmployeeForm: React.FC<Props> = ({ submitFn, empl }) => {
    const { minYear, minSalary, maxYear, maxSalary, departments }
        = employeeConfig;
    const {id, birthDate, name, department, salary, gender} = empl;
    const initialEmployee: Employee = {
        id: id, birthDate: birthDate, name: name,department: department, salary: salary,
         gender: gender}
        ...
        <form onSubmit={onSubmitFn} onReset={onResetFn}>
            <Grid container spacing={4} justifyContent="center">
                ...
                <Grid item xs={8} sm={4} md={5}>
                    <TextField disabled type="date" required fullWidth label="birthDate"
                ...
                <Grid item xs={8} sm={4} md={5}>
                    <FormControl disabled required error={!!errorMessage}>
